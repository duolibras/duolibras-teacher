    ...
    <>
      {(courses.length === 0 && !isLoading) && (
        <div className="flex h-full items-center justify-center flex-col space-y-4" >
          ...
          Você ainda não tem nenhum conteúdo
          <CreateCourseModal>Criar meu primeiro conteúdo</CreateCourseModal>
        </div>
      )}
      ...
      {(courses.length > 0 && !isLoading) && (
        <div className="p-4">
          <div className="flex justify-between">
            <h1 className="tracking-tight text-3xl mb-4">Meus conteúdos</h1>
            <CreateCourseModal>Criar conteúdo</CreateCourseModal>
          </div>
